...
import br.com.daviluiz.todolist.utils.Utils;
...
public class TaskController {
  ...
  public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request) {
    ...
    // validação da data de início da tarefa
    // 10/11/2023 - current
    // 10/10/2023 - startAt
    ...
    // validação da data de início que de ver ser menor que a data de término
